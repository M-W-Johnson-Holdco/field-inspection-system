...
export const ROOF_ITEMS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { t: 'num', l: 'Exposure (inches)', full: true, inchesOnly: true },
    ],
  },
  {
  ...
  },
  {
    ...
    subItemSizeCounters: {
      ...
      labelSuffix: '',
      counterLabel: 'size',
      fromMeasuredHeight: true,
      equalWidth: true,
      legend: 'Small 3–4" · Medium 5–7" · Large 8"+',
    },
    fields: [
      { t: 'yn', l: 'Painted', allowNA: false },
    ],
    subFields: [
      { t: 'num', l: 'Diameter', full: true },
      { t: 'multi', l: 'Damaged', o: ['Cap', 'Stack', 'Flange'], allowNA: true, full: true, nativeMenu: true },
    ],
  },
  {
  ...
  },
  {
    ...
    subItemSizeCounters: {
      ...
      labelSuffix: '',
      counterLabel: 'size',
      fromMeasuredWidth: true,
      equalWidth: true,
      legend: 'Small ≤23" · Medium 24–36" · Large 37"+',
    },
    fields: [
      { t: 'yn', l: 'Painted', full: true },
    ],
    subFields: [
      { t: 'num', l: 'Width', full: true },
      ...
      { t: 'yn', l: 'Chimney Cover Existing?', allowNA: true, full: true },
      { t: 'yn', l: 'Damaged', full: true },
    ],
    subItemNestedSection: {
      title: 'Chimney Cover',
      showWhen: { field: 'Chimney Cover Existing?', equals: 'Yes' },
      afterPhotos: true,
      fields: [
        ...
        { t: 'yn', l: 'Cover Painted', displayLabel: 'Painted', allowNA: true, full: true },
        {
          t: 'multi',
          l: 'Cover Damaged',
      ...
      damageField: 'Cover Damaged',
      damageDescKey: '_cover_damage',
      notesKey: '_cover_notes',
      photosKey: 'coverPhotos',
    },
  },
  {
  ...
  },
  {
    ...
    subFields: [
      ...
      },
      {
        ...
        fieldHint: 'Adjust EITHER Diameter or Total Circumference',
